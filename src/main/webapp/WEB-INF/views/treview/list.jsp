  ...
  <div id="wrapper">
    ...
    <section id="maincontent">
      <div class="container">
          ...
          <h3><a href="/treview/list">여행후기 목록</a></h3>
        </div>
        ...
        <div class="row">
          <div class="span12">
            <div class="pagination">
              <ul>
              	<li><a href="/treview/write">여행후기 작성하기</a></li>
              </ul>
            </div>
          </div>
        </div>
	            ...
	            <div class="pagination">
	              <ul>
	              	<c:if test="${treviewList[0].page ne 1}">
	                	<li><a href="/treview/list?page=${treviewList[0].page - 1}">Prev</a></li>
	                </c:if>
	                ...
	                <c:forEach begin="${treviewList[0].start_page}" end="${treviewList[0].start_page + treviewList[0].page_rows - 1}" var="page">
	                	<c:if test="${page <= treviewList[0].cnt_page}">
	                		<li class="${page eq treviewList[0].page ? 'active' : ''}"><a href="/treview/list?page=${page}">${page}</a></li>
	                	</c:if>
	                </c:forEach>
	                
	                <c:if test="${treviewList[0].page ne treviewList[0].cnt_page}">
	                	<li><a href="/treview/list?page=${treviewList[0].page + 1}">Next</a></li>
	                </c:if>
	              </ul>
	            </div>
	          </div>
